...
<div class="container py-5 h-100">
  <div class="row d-flex align-items-center justify-content-center h-100">
    ...
    <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
      <div class="mb-5">
        <i class="fa-solid fa-money-bill-1-wave fa-2x" style="color: #2d31fa"></i>
        <span class="h1 fw-bold mb-0">Payfoll</span>
      </div>
      <form action="/login" method="post" class="need-validated">
        @csrf
        ...
        <div class="d-grid gap-2 pt-4">
          <button type="submit" class="btn btn-primary btn-lg btn-block fw-bold">Log In</button>
        </div>
      </form>
    </div>
  </div>
